...
use RecipeBookBundle\Entity\Ingredient;
use RecipeBookBundle\Form\IngredientType;
...
class IngredientController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('RecipeBookBundle:Ingredient')->findAll();
     ...
     * @Method("POST")
     * @Template("RecipeBookBundle:Ingredient:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('RecipeBookBundle:Ingredient')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("RecipeBookBundle:Ingredient:edit.html.twig")
     */
