...
use RecipeBookBundle\Entity\Recipe;
use RecipeBookBundle\Form\RecipeType;
...
class RecipeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('RecipeBookBundle:Recipe')->findAll();
     ...
     * @Method("POST")
     * @Template("RecipeBookBundle:Recipe:new.html.twig")
     */
    ...
    */
     ...
     * @Method("PUT")
     * @Template("RecipeBookBundle:Recipe:edit.html.twig")
     */
